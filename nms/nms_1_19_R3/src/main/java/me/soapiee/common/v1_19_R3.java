...
class v1_19_R3 implements NMSProvider {
    ...
    public boolean setSpectator(Player player) {
        ...
        list.add(new ClientboundPlayerInfoUpdatePacket.Entry(player.getUniqueId(), p.getBukkitEntity().getProfile(), false, 0, GameType.CREATIVE, p.getTabListDisplayName(), null));
